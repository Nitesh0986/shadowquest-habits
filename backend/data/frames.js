// The shop sells avatar frames only. Definitions live in code, the database only
// stores which frame ids a player owns. Ids match the artwork in the frontend's
// components/Avatar.jsx, so a new frame needs an entry here and a drawing there.
export const FRAMES = [
